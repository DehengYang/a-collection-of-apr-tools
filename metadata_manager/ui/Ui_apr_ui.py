...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem1 = QtWidgets.QSpacerItem(
            600, 17, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum
        )
        ...
        self.lineEdit_year = QtWidgets.QLineEdit(self.widget_2)
        ...
        self.lineEdit_target_language = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_target_language.setObjectName("lineEdit_target_language")
        self.gridLayout.addWidget(self.lineEdit_target_language, 5, 1, 1, 1)
        ...
        self.lineEdit_ccf_rank = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_ccf_rank.setObjectName("lineEdit_ccf_rank")
        self.gridLayout.addWidget(self.lineEdit_ccf_rank, 7, 1, 1, 1)
        self.lineEdit_authors = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_authors.setObjectName("lineEdit_authors")
        self.gridLayout.addWidget(self.lineEdit_authors, 3, 1, 1, 1)
        self.lineEdit_venue = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_venue.setObjectName("lineEdit_venue")
        self.gridLayout.addWidget(self.lineEdit_venue, 2, 1, 1, 1)
        self.lineEdit_repo_url = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_repo_url.setObjectName("lineEdit_repo_url")
        self.gridLayout.addWidget(self.lineEdit_repo_url, 4, 1, 1, 1)
        ...
        self.lineEdit_used_dataset = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_used_dataset.setObjectName("lineEdit_used_dataset")
        self.gridLayout.addWidget(self.lineEdit_used_dataset, 6, 1, 1, 1)
        ...
        self.lineEdit_bug_types = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_bug_types.setObjectName("lineEdit_bug_types")
        self.gridLayout_2.addWidget(self.lineEdit_bug_types, 3, 1, 1, 1)
        self.lineEdit_apr_tool_name = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_apr_tool_name.setObjectName("lineEdit_apr_tool_name")
        self.gridLayout_2.addWidget(self.lineEdit_apr_tool_name, 0, 1, 1, 1)
        self.lineEdit_specification = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_specification.setText("")
        self.lineEdit_specification.setObjectName("lineEdit_specification")
        self.gridLayout_2.addWidget(self.lineEdit_specification, 1, 1, 1, 1)
        self.lineEdit_tool_category = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_tool_category.setObjectName("lineEdit_tool_category")
        self.gridLayout_2.addWidget(self.lineEdit_tool_category, 2, 1, 1, 1)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(
            595, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum
        )
        ...
        spacerItem6 = QtWidgets.QSpacerItem(
            594, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum
        )
